...
public class Worn : MonoBehaviour, IBoss
{
    ...
    {
        animator.SetInteger("transition", 2);
        GameObject FireBall = Instantiate(bullet, firePoint.position, firePoint.rotation);
        FireBall bowComponent = FireBall.GetComponent<FireBall>();
